...
class CountriesTableSeeder extends Seeder
{
    public function run()
    {
		DB::table('countries')->insert([
			...
			['name' => 'Antigua and/or Barbuda', 'code' => 'AG'],
			...
			['name' => 'Brazil', 'code' => 'BR'],
			['name' => 'British lndian Ocean Territory', 'code' => 'IO'],
			...
			['name' => 'Qatar', 'code' => 'QA'],
			['name' => 'Republic of South Sudan', 'code' => 'SS'],
			...
			['name' => 'Svalbarn and Jan Mayen Islands', 'code' => 'SJ'],
