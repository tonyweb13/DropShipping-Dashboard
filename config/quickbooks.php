...
return [
    ...
    */
    ...
    /*
    |-------------------------------------------------------------------------
    | This variable is for dynamic use only
    |-------------------------------------------------------------------------
    |
    */

    'dynamic' => [
        'client_id_us' => env('QUICKBOOKS_ID_US'),
        'client_secret_us' => env('QUICKBOOKS_SECRET_US'),
        'client_id_uk' => env('QUICKBOOKS_ID_UK'),
        'client_secret_uk' => env('QUICKBOOKS_SECRET_UK'),
    ],
