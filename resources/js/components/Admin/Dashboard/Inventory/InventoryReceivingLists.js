...
class InventoryLists extends Component {
            ...
            },
            {
                ...
                renderCell: (params) => {
                    return (
                        ...
                        >
                            {params.row.notes
                                ? params.row.notes.substring(0, 20)
                                : "Show Notes"}
                            ...
                        </Button>
                    );
                        ...
                        return (
                            <div>
                                <Button
                                    ...
                                    className="archive_btn_table autowidth  padrl20"
                                >
                                    &nbsp;&nbsp; Restore
                                </Button>{" "}
                                <Button
    ...
    getData = (data) => {
        ...
        axios
            .get(
                "api/admin-receivingproducts?history=" +
                    this.historydata +
                    "&statusfilter=" +
                    this.statfilter +
                    "&stocktype=" +
    ...
    handleOpenModalHistory = (inventoryid) => {
        axios
            .get("api/admin-product?inventoryid=" + inventoryid)
            .then((response) => {
                this.setState({
                    historyModal: true,
    ...
    handleInventorySubmitNotes(e) {
        ...
        axios
            .post("api/admin-add-receiving-notes", inventoryData, config)
            .then((response) => {
                this.setState({
                    openModalNotes: false,
                    formSubmitting: false,
    ...
    handleInventorySubmit(e) {
        ...
        axios
            .post("api/admin-add-receiving", inventoryData, config)
            .then((response) => {
                this.setState({
                    openModal: false,
                    global_msg: {
    ...
    handleChangeReceivingItemsStatus = (receivestatus) => {
        if (this.state.receiveditems.length > 0) {
            ...
            axios
                .post("api/admin-add-receiving-items", shipmentData)
                .then((response) => {
                    this.setState({
                        receiveditems: [],
                        global_msg: {
    ...
    handleChangeReceivingStatus = (receiveid, receivestatus) => {
        ...
        shipmentData.append("status", receivestatus);
        axios
            .post("api/admin-change-receivingstatus", shipmentData)
            .then((response) => {
                this.getData({ page: 1 });
                this.setState({
    ...
    handleShowForm = (event) => {
        axios.get("api/admin-productslist").then((response) => {
            const product_options = [];
            response.data.products.forEach(function (key) {
                let row_grid_data = {
                    value: key.ProductVariantID,
                    label: key.ProductAlias,
                };
                        ...
                        >
                            ...
                            >
                                ...
                                <div
                                    style={{
                                        display:
                                            this.state.showchangestatusbtns,
                                    }}
                                >
                                    <Button
                                        variant="outlined"
                                    ...
                                    &nbsp;
                                    {/*<Button variant="outlined" onClick={this.handleChangeReceivingItemsStatus.bind(this, 'Disputed')} className="archive_btn_table">Dispute</Button> &nbsp;*/}
                                </div>
                                <div
                                    style={{
                                        display: this.state.showrestorebtn,
                                    }}
                                >
                                    <Button
                                        variant="outlined"
