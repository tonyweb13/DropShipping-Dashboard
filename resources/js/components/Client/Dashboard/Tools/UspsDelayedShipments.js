...
class UspsDelayedShipments extends Component {
    constructor(props) {
        super(props);
        const defaultcolumns = [
            ...
            },
            {
                ...
                renderCell: (params) => {
                    return (
                        <Link
                            href={`https://tools.usps.com/go/TrackConfirmAction?tRef=fullpage&tLc=2&text28777=&tLabels=${params.row.TrackingNumber}`}
                            target="_blank"
                        >
        ...
        this.state = {
            location: "uspsdelayed-shipments",
            title: "USPS Delayed Shipments",
    ...
    getData = (data) => {
        ...
        axios
            .get(
                "api/delayed-shipments?startdate=" +
                    startdate +
                    "&enddate=" +
                    enddate
            )
            .then((response) => {
                ...
                response.data.lists.forEach(function (key) {
                    let row_grid_data = {
                        ...
                        DeliveryStatus: key.DeliveryStatus,
                        actions: key.ID,
                    };
...
export default UspsDelayedShipments;
