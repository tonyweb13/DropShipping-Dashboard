...
class Pricing extends Component {
    constructor(props) {
        ...
        this.state = {
            location: "pricing-ustous-economy",
            title: "Pricing",
            pricing: [],
            data: [],
            units: "lb",
    ...
    getData = (data) => {
        axios
            .get("api/getpricingdata?pricingtype=ustous&shipping=economy")
            .then((response) => {
                this.setState({
    ...
    handleChangeWeight = (event) => {
        ...
        axios
            .get(
                "api/getcalctotal?pricingtype=ustous&shipping=economy&weight=" +
                    event.target.value +
                    "&units=" +
                    this.state.units
            )
