...
class Pricing extends Component {
    constructor(props) {
        ...
        this.state = {
            location: "pricing-ustononus-standard",
            title: "Pricing",
            pricing: [],
            data: [],
            units: "lb",
    ...
    getData = (data) => {
        axios
            .get("api/getpricingdata?pricingtype=ustononus&shipping=standard")
            .then((response) => {
                this.setState({
    ...
    handleChangeWeight = (event) => {
        ...
        axios
            .get(
                "api/getcalctotal?pricingtype=ustononus&shipping=standard&weight=" +
                    event.target.value +
                    "&units=" +
                    this.state.units
            )
                        ...
                        <Container maxWidth="lg" sx={{ mt: 4, mb: 4 }}>
                            <Grid container spacing={3}>
                                <Grid item xs={12}>
                                    ...
                                    >
                                        US to NON-US | Standard Shipping
                                    </Typography>
                                    <Paper
                                        sx={{
                                            p: 2,
