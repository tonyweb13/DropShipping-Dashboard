...
class Pricing extends Component {
    constructor(props) {
        ...
        this.state = {
            location: "pricing-ustononus-canada",
            title: "Pricing",
            pricing: [],
            data: [],
            units: "lb",
    ...
    getData = (data) => {
        axios
            .get("api/getpricingdata?pricingtype=ustononus&shipping=canada")
            .then((response) => {
                this.setState({
    ...
    handleChangeWeight = (event) => {
        ...
        axios
            .get(
                "api/getcalctotal?pricingtype=ustononus&shipping=canada&weight=" +
                    event.target.value +
                    "&units=" +
                    this.state.units
            )
