...
class Pricing extends Component {
    constructor(props) {
        ...
        this.state = {
            location: "pricing-ustononus-mexico",
            title: "Pricing",
            pricing: [],
            data: [],
            units: "lb",
    ...
    getData = (data) => {
        axios
            .get("api/getpricingdata?pricingtype=ustononus&shipping=mexico")
            .then((response) => {
                this.setState({
    ...
    handleChangeWeight = (event) => {
        ...
        axios
            .get(
                "api/getcalctotal?pricingtype=ustononus&shipping=mexico&weight=" +
                    event.target.value +
                    "&units=" +
                    this.state.units
            )
